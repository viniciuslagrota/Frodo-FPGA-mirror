...
HD_PWD='C:/Projects/frodo-fpga/frodo-fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log frodoBD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source frodoBD_wrapper.tcl -notrace
