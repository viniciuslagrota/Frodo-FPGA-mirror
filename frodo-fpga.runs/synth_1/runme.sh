...
HD_PWD='C:/Projects/frodo-fpga/frodo-fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log frodoBD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source frodoBD_wrapper.tcl
