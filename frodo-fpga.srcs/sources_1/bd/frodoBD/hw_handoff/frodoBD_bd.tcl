...
proc create_root_design { parentCell } {
  ...
  # Create instance: shake128_mm_ip_0, and set properties
  set shake128_mm_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:shake128_mm_ip:1.0 shake128_mm_ip_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M13_AXI [get_bd_intf_pins axi_interconnect_0/M13_AXI] [get_bd_intf_pins shake128_mm_ip_0/S00_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins axi_gpio_7/gpio_io_i] [get_bd_pins shake128_mm_ip_0/inlen]
  connect_bd_net -net Net1 [get_bd_pins axi_gpio_7/gpio2_io_i] [get_bd_pins shake128_mm_ip_0/outlen]
  ...
  connect_bd_net -net axi_gpio_6_gpio_io_o [get_bd_pins axi_gpio_6/gpio_io_o] [get_bd_pins shake128_mm_ip_0/start]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C60000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs shake128_mm_ip_0/S00_AXI/S00_AXI_reg] SEG_shake128_mm_ip_0_S00_AXI_reg
