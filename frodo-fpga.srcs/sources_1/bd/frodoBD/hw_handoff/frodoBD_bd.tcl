...
proc create_root_design { parentCell } {
  ...
  # Create instance: mult_add_sa_plus_e_mm_ip_0, and set properties
  set mult_add_sa_plus_e_mm_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:mult_add_sa_plus_e_mm_ip:1.0 mult_add_sa_plus_e_mm_ip_0 ]
  set_property -dict [ list \
   CONFIG.C_S00_AXI_ADDR_WIDTH {6} \
   CONFIG.C_S01_AXI_ADDR_WIDTH {13} \
   CONFIG.C_S02_AXI_ADDR_WIDTH {14} \
 ] $mult_add_sa_plus_e_mm_ip_0
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins axi_interconnect_0/M06_AXI] [get_bd_intf_pins mult_add_sa_plus_e_mm_ip_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins axi_interconnect_0/M07_AXI] [get_bd_intf_pins mult_add_sa_plus_e_mm_ip_0/S01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins axi_interconnect_0/M08_AXI] [get_bd_intf_pins mult_add_sa_plus_e_mm_ip_0/S02_AXI]
  ...
  connect_bd_net -net axi_gpio_4_gpio_io_o [get_bd_pins axi_gpio_4/gpio_io_o] [get_bd_pins mult_add_sa_plus_e_mm_ip_0/start]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mult_add_sa_plus_e_mm_ip_0/S00_AXI/S00_AXI_reg] SEG_mult_add_sa_plus_e_m_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mult_add_sa_plus_e_mm_ip_0/S01_AXI/S01_AXI_reg] SEG_mult_add_sa_plus_e_m_0_S01_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mult_add_sa_plus_e_mm_ip_0/S02_AXI/S02_AXI_reg] SEG_mult_add_sa_plus_e_m_0_S02_AXI_reg
