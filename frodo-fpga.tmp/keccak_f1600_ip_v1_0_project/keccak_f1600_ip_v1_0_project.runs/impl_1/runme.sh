...
HD_PWD='c:/projects/frodo-fpga/frodo-fpga.tmp/keccak_f1600_ip_v1_0_project/keccak_f1600_ip_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log keccak_f1600_ip_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source keccak_f1600_ip_v1_0.tcl -notrace
