...
HD_PWD='c:/projects/frodo-fpga/frodo-fpga.tmp/keccak_f1600_mm_ip_v1_0_project/keccak_f1600_mm_ip_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log keccak_f1600_mm_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source keccak_f1600_mm_ip_v1_0.tcl
