...
HD_PWD='c:/projects/frodo-fpga/frodo-fpga.tmp/matrix_sa_plus_e_mm_ip_v1_0_project/matrix_sa_plus_e_mm_ip_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_sa_plus_e_mm_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_sa_plus_e_mm_ip_v1_0.tcl
