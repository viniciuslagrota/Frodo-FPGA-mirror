...
HD_PWD='c:/projects/frodo-fpga/frodo-fpga.tmp/shake128_ip_v1_0_project/shake128_ip_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shake128_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shake128_ip_v1_0.tcl
